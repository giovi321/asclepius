...
export function SettingsForm({ title, children, onSave, saving, saved }: {
...
export function TextField({ label, value, onChange, placeholder, type = "text", description }: {
...
export function ToggleField({ label, value, onChange, description }: {
...
export function useSettingsSave() {
  ...
  const save = async (updates: Record<string, any>) => {
    ...
    } catch { toast({ title: "Failed to save settings", variant: "error" }); }
    setSaving(false);
  };
