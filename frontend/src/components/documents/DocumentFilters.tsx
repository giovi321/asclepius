...
export default function DocumentFilters({
  search, typeFilter, statusFilter, specialtyFilter,
  doctorFilter, facilityFilter, dateFrom, dateTo,
  onChange, onClearAll,
  visibleCols, onVisibleColsChange, onUploadClick,
  ...
  const hasAnyFilter = !!(
    dateFrom || dateTo ||
    typeFilter.length || statusFilter.length || specialtyFilter.length ||
    doctorFilter.length || facilityFilter.length
  );
