...
export default function SearchableSelect({
  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      ...
      >
        <span
          className={`truncate text-left ${selectedOption ? "" : "text-muted-foreground"}`}
        >
      ...
      {open && (
        <div
          className={`absolute top-full mt-1 z-30 rounded-lg border bg-background shadow-xl w-80 max-w-[360px] ${alignRight ? "right-0" : "left-0"}`}
        >
