...
async def list_patients(
    ...
    return await get_patients_for_user(db, current_user["id"], user_role=current_user.get("role"))
...
async def get_patient(
    ...
    # Get document count
    cursor = await db.execute("SELECT COUNT(*) FROM documents WHERE patient_id = ?", (patient_id,))
