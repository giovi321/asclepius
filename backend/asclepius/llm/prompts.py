...
# ---------------------------------------------------------------------------
# Vision-LLM: single-step OCR + classification + universal-fields extraction
# ---------------------------------------------------------------------------

VISION_EXTRACTION_PROMPT = """Look at this medical document image carefully. First, read ALL the text you can see. Then classify the document.
